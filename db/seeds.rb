...
Review.create!(
  [
    {item_name: 'ワンワンビスケット', item_price: '450', dog_breed: '柴犬', tag_id: 1, review: 'とっても気に入ったようで美味しそうに食べています！', rate: '5', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.JPG"), filename:"sample-post1.JPG"), customer_id: 4},
    ...
    {item_name: 'チューイングスティック 超小型犬用', item_price: '440', dog_breed: 'チワワ', tag_id: 1, review: '食後にあげてます。喜んで食べます。', rate: '5', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post4.JPG"), filename:"sample-post4.JPG"), customer_id: 2}
  ]
)